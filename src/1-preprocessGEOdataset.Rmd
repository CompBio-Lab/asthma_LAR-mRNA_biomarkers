...
library(biomaRt)
library(here)
source(here("src", "utils", "impute_sex.R"))
```
...
gse69683_sex <- impute_sex(eset = exp3, true_sex=sex)$acc
...
gse147878_sex <- impute_sex(eset = exp3, true_sex=true_sex)$acc
...
true_sex[true_sex == "female"] <- "F"
true_sex[true_sex == "male"] <- "M"
gse147880_sex <- impute_sex(eset = exp3, true_sex=true_sex)$acc
...
true_sex[true_sex == "female"] <- "F"
true_sex[true_sex == "male"] <- "M"
gse76262_sex <- impute_sex(eset = exp3, true_sex=true_sex)$acc
```
...
## compare imputed sex with actual sex per GSE study

```{r}
data.frame(gse = c("GSE69683", "GSE147878", "GSE147880", "GSE76262"),
           acc = c(gse69683_sex, gse147878_sex, gse147880_sex, gse76262_sex)) %>% 
  ggplot(aes(x = reorder(gse, -acc),
             y = acc)) +
