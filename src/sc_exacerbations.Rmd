...
pdf(here::here("results", "all_cells_heatmap.pdf"), width = 18, height = 5)
Heatmap(logfc2, right_annotation = row_ha,
...
logfc$condition[logfc$condition == "AA"] <- "Allergic Asthma"
logfc$condition[logfc$condition == "AC"] <- "Allergic Controls"
pdf(here::here("results", "mnp_cells_heatmap.pdf"), width = 18, height = 5)
Heatmap(logfc2, right_annotation = row_ha,
        row_split = logfc$condition,
        border = TRUE, name="logFC",
    cell_fun = function(j, i, x, y, width, height, fill) {
...
logfc$condition[logfc$condition == "AA"] <- "Allergic Asthma"
logfc$condition[logfc$condition == "AC"] <- "Allergic Controls"
pdf(here::here("results", "t_cells_heatmap.pdf"), width = 18, height = 5)
Heatmap(logfc2, right_annotation = row_ha, 
        row_split = logfc$condition,
        border = TRUE, name="logFC",
    cell_fun = function(j, i, x, y, width, height, fill) {
